const CACHE_NAME = 'nosmo-emergency-core-v1-0006-20260906';
const STATIC_ASSETS = [
  './','./index.html','./styles.css','./engine.css','./site-medical.css','./site-card.css','./app.webmanifest',
  './src/app.js','./src/emergency-state.js','./src/site-medical-ui.js','./src/site-emergency-card.js','./icons/icon-192.png','./icons/icon-512.png'
];
